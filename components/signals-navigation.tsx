...
export function SignalsNavigation() {
            ...
            >
              ...
              <div className="mt-8">
                <Link
                  ...
                  className="flex items-center gap-1.5 text-[10px] font-mono text-muted-foreground/40 hover:text-foreground/60 transition-colors"
                >
